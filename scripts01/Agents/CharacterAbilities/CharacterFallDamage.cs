...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterFallDamage : CharacterAbility
    {
        ...
        public override void ProcessAbility()
        {
            ...
            if (_airborneLastFrame && !_character.Airborne)
            {
                float distance = Mathf.Abs(_takeOffAltitude - this.transform.position.y);
        ...
        {
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _fallDamageAnimationParameter, _damageThisFrame, _character._animatorParameters);            
        }
    }
}
