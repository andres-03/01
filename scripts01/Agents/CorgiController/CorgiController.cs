...
{	
	...
	public class CorgiController : MonoBehaviour 
	{
		...
		[Header("Raycasting")]
		[MMInformation("Here you can define how many rays are cast horizontally and vertically. You'll want them as far as possible from each other, but close enough that no obstacle or enemy can fit between 2 rays.",MoreMountains.Tools.MMInformationAttribute.InformationType.Info,false)]
